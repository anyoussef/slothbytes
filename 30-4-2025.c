...
/*
    Given an array of size 10 with a range of 0-10 determine if the order of integers are
    shuffled well. I.E. 3 or more numbers do not appear in order acsending or descending.
